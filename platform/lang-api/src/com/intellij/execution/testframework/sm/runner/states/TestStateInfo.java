...
public interface TestStateInfo {
  ...
  enum Magnitude {
    ...
    SCHEDULED_INDEX(3, 8, ExecutionBundle.message("sm.test.runner.magnitude.scheduled.failed.title")),
    ...
    TIMEOUT_INDEX(4, 6, ExecutionBundle.message("sm.test.runner.magnitude.timeout.failed.title")),
    INFRASTRUCTURE_FAILURE_INDEX(4, 6, ExecutionBundle.message("sm.test.runner.magnitude.infrastructure.failed.title")),
    TRIGGERING_ERROR_INDEX(4, 6, ExecutionBundle.message("sm.test.runner.magnitude.triggering.failed.title")),
